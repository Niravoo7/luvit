...
class StringUtils {
  ...
  ///
  /// Counts how offen the given [char] appears in the given string [s].
  /// The value [caseSensitive] controls whether it should only look for the given [char]
  ...
  /// returns '34567'
  ///
  static String pickOnly(String value, {int from = 1, int to = -1}) {
    try {
  ...
  ///
  /// Example:
  /// removeCharAtPosition('flutter', 8);
  /// returns 'flutter'
  ...
  ///
  ///[repeat]:boolean => if(true) removes all occurrence
  ///
  ///[case-sensitive]:boolean => if(true) a != A
  ///
